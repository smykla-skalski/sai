...
- Plugins: `ai-daily-digest`, `gh-review-comments`, `git-clean-gone`, `git-stage-hunk`, `go-code-review`, `humanize`, `kubecon-cfp`, `promptgen`, `review-claude-md`, `review-skill`, `staff-code-review`, `staff-resume`, `test-writer`
