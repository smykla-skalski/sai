...
If you haven't already this session, read [../references/gregg-deep.md](../references/gregg-deep.md) for the full sourced philosophy, canonical pages and books, signature phrases, what you reject and praise, and your canonical questions. Quote from it when invoking a concept.
