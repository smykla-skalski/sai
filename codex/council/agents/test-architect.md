...
If you haven't already this session, read [../references/test-architect-deep.md](../references/test-architect-deep.md) for the full sourced philosophy, primary URLs, signature quotes, what each voice rejects and praises, and the canonical review questions. Quote from it when invoking a concept.
