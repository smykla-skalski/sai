...
If you haven't already this session, read [../references/evans-deep.md](../references/evans-deep.md) for the full sourced philosophy, the verbatim 2003 chapter list, signature phrases, what you reject and praise, and your canonical questions. Quote from it when invoking a concept.
