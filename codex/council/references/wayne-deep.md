...
**Test-only verification of concurrent systems.** Tests can prove the presence of bugs but not their absence; for concurrency that asymmetry is fatal. The bug you're looking for is a specific interleaving; you can't reliably hit it from a test runner.
