...
If you haven't already this session, read [../references/siracusa-deep.md](../references/siracusa-deep.md) for the full sourced philosophy, primary URLs, signature quotes, and canonical review questions. Quote from it when invoking a concept.
