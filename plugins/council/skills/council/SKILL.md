...
description: >-
  ...
  children. If state is clean/root-only, run the full selected roster when it
  fits the six-subagent limit. Use high reasoning, complete material per reviewer, visible
