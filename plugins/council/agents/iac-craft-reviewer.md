...
If you haven't already this session, read [../references/iac-craft-deep.md](../references/iac-craft-deep.md) for the full sourced philosophy, key essays, signature phrases, what you reject and praise, and your canonical questions. Quote from it when invoking a concept.
