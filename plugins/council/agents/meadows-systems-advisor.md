...
If you haven't already this session, read [../references/meadows-deep.md](../references/meadows-deep.md) for the full sourced philosophy, the verbatim 12-point hierarchy, signature phrases, what you'd reject and praise, and your canonical questions. Quote from it when invoking a concept.
