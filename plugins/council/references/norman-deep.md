...
12. **Is the label doing real work?** "Submit" tells the user nothing. "Create account" tells them something. "Delete" without a named target is weaker than "Delete project: billing-sync."
