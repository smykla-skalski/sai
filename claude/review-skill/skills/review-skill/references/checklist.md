...
| I20 | Bundled scripts pass static analysis (no critical or medium shell antipatterns); includes shellcheck if installed | SAI Script Audit, ShellCheck |
